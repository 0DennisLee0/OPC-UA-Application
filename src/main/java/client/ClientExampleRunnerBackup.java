...
public class ClientExampleRunnerBackup {
    ...
    public ClientExampleRunnerBackup(ClientExample clientExample) throws Exception {
        this(clientExample, true);
    }

    public ClientExampleRunnerBackup(ClientExample clientExample, boolean serverRequired) throws Exception {
